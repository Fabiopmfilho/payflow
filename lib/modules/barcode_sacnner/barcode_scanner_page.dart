...
class BarcodeScannerPage extends StatefulWidget {
  ...
  @override
  _BarcodeSacnnerPageState createState() => _BarcodeSacnnerPageState();
}

class _BarcodeSacnnerPageState extends State<BarcodeScannerPage> {
              ...
              builder: (_, status, __) {
                if (status.hasError) {
                  return BottomSheetWidget(
                    title: 'Não foi possível identicar um código de barras.',
                    subtitle:
